---
title: "How to Use Burgers Footage in Creative Projects | Stockflow.media"
description: "**Burgers** footage captures food at its most cinematic — ideal for restaurant brands, food bloggers, delivery apps, and culinary content creators."
---
...
[Browse the Burgers Collection](https://stockflow.media/?cat=Food+%26+Beverage&sub=Food+Menu&collection=Burgers){ .md-button .md-button--primary }<iframe width="100%" height="450" style="max-width: 800px; aspect-ratio: 16/9; border-radius: 8px; margin-bottom: 20px;" src="https://www.youtube.com/embed/vIbaqq00iOU?rel=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
1. Download the asset from [Stockflow.media](https://stockflow.media/?cat=Food+%26+Beverage&sub=Food+Menu&collection=Burgers)
...
[Browse Burgers on Stockflow.media](https://stockflow.media/?cat=Food+%26+Beverage&sub=Food+Menu&collection=Burgers){ .md-button .md-button--primary }
