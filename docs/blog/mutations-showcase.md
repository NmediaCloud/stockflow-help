...
[Browse the Mutations Collection](https://stockflow.media/?cat=Microscopic&sub=Cancer+Cell){ .md-button .md-button--primary }
...
This guide explores how to use the **Mutations** collection — 8 premium assets available in 4K/8K — across real creative workflows.
...
[Browse Mutations on Stockflow.media](https://stockflow.media/?cat=Microscopic&sub=Cancer+Cell){ .md-button .md-button--primary }
