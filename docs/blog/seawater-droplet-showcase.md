---
title: "How to Use Seawater Droplet Footage in Creative Projects | Stockflow.media"
description: "**Seawater Droplet** visuals bring the invisible world to life — ideal for science communicators, educators, documentary makers, and digital designers."
---
...
[Browse the Seawater Droplet Collection](https://stockflow.media/?cat=Microscopic&sub=Underwater&collection=Seawater+Droplet){ .md-button .md-button--primary }
...
1. Download the asset from [Stockflow.media](https://stockflow.media/?cat=Microscopic&sub=Underwater&collection=Seawater+Droplet)
...
[Browse Seawater Droplet on Stockflow.media](https://stockflow.media/?cat=Microscopic&sub=Underwater&collection=Seawater+Droplet){ .md-button .md-button--primary }
