---
title: "How to Use Spirochete Footage in Creative Projects | Stockflow.media"
description: "**Spirochete** visuals bring the invisible world to life — ideal for science communicators, educators, documentary makers, and digital designers."
---
...
[Browse the Spirochete Collection](https://stockflow.media/?cat=Microscopic&sub=Bacteria&collection=Spirochete){ .md-button .md-button--primary }<iframe width="100%" height="450" style="max-width: 800px; aspect-ratio: 16/9; border-radius: 8px; margin-bottom: 20px;" src="https://www.youtube.com/embed/J7JmJi32kxw?rel=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

---

## Introduction

**Spirochete** visuals bring the invisible world to life — ideal for science communicators, educators, documentary makers, and digital designers.

This guide explores how to use the **Spirochete** collection — 13 premium assets available in 4K/8K — across real creative workflows.
...
1. Download the asset from [Stockflow.media](https://stockflow.media/?cat=Microscopic&sub=Bacteria&collection=Spirochete)
...
[Browse Spirochete on Stockflow.media](https://stockflow.media/?cat=Microscopic&sub=Bacteria&collection=Spirochete){ .md-button .md-button--primary }
