---
title: "How to Use Tetani Footage in Creative Projects | Stockflow.media"
description: "**Tetani** visuals bring the invisible world to life — ideal for science communicators, educators, documentary makers, and digital designers."
---
...
[Browse the Tetani Collection](https://stockflow.media/?cat=Microscopic&sub=Bacteria&collection=Tetani){ .md-button .md-button--primary }<iframe width="100%" height="450" style="max-width: 800px; aspect-ratio: 16/9; border-radius: 8px; margin-bottom: 20px;" src="https://www.youtube.com/embed/JFyTM60xUNI?rel=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

---

## Introduction

**Tetani** visuals bring the invisible world to life — ideal for science communicators, educators, documentary makers, and digital designers.

This guide explores how to use the **Tetani** collection — 10 premium assets available in 4K/8K — across real creative workflows.
...
1. Download the asset from [Stockflow.media](https://stockflow.media/?cat=Microscopic&sub=Bacteria&collection=Tetani)
...
[Browse Tetani on Stockflow.media](https://stockflow.media/?cat=Microscopic&sub=Bacteria&collection=Tetani){ .md-button .md-button--primary }
