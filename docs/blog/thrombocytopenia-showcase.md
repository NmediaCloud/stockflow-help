...
🏠 [Home](../index.md) → [Microscopic](../categories/microscopic.md) → [Blood Hematology](../subcategories/blood-hematology.md) → **Thrombocytopenia Blog**

[🌐 Browse the Thrombocytopenia Collection](https://stockflow.media/?cat=Microscopic&sub=Blood+Hematology){ .md-button .md-button--primary }

---

## Introduction

**Thrombocytopenia** visuals bring the invisible world to life — perfect for science communicators, educators, documentary makers, and digital designers.
...
[🌐 Browse Thrombocytopenia on Stockflow.media](https://stockflow.media/?cat=Microscopic&sub=Blood+Hematology){ .md-button .md-button--primary }
