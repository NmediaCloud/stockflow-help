...
[Browse on Stockflow.media](https://stockflow.media/?cat=Microscopic&sub=Bacteria&collection=Bacillus){ .md-button .md-button--primary }This collection contains **23 assets** available in multiple resolutions and aspect ratios.
