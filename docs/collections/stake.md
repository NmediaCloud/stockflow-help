...
[Browse on Stockflow.media](https://stockflow.media/?cat=Food+%26+Beverage&sub=Food+Menu&collection=Stake){ .md-button .md-button--primary }This collection contains **59 assets** available in multiple resolutions and aspect ratios.
