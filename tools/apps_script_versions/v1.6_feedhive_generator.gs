...
function readControlPanel_() {
  ...
  for (var i = 1; i < data.length; i++) {
    ...
    if (section === "platforms") {
      ...
      // Content Type filter: col0 = type name, col2 = checkbox
      settings.enabledContentTypes[col0] = (col2 === true);
    } else if (section === "format") {
      // Format filter: col0 = W/S/V, col2 = checkbox
      settings.enabledFormats[col0] = (col2 === true);
    }
  }
